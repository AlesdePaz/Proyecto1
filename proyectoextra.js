...
// recargo por sueldo 5% sobre el salario del asegurado
 var sueldo = 0
...
if("SI" == hijos.toUpperCase()){
  cantidad_hijos = prompt("¿cuantos hij@s tiene?")
}
/**
...
//extras
  propiedades = parseInt(prompt ("cuantas propiedades tiene? Ingrese solamente números"))
 //se realiza el recargo por propiedades
  for (var i = 1; i <= propiedades; i++){
//instrucciones a ejecutar
 recargo_propiedades_total = precio_base * recargo_propiedades
  recargo_total = recargo_total + recargo_propiedades_total
}

  sueldo = parseInt(prompt ("cual es su salario mensual? Ingrese solamente números"))
 /*se realiza el recargo por sueldo
 instrucciones a ejecutar*/
 recargo_salario_total = sueldo * recargo_salario
  recargo_total = recargo_total + recargo_salario_total
